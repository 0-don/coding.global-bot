...
| `/delete-user-messages`         | Delete a user's messages and/or jail them (not on someone at or above your rank) | `user`, `user-id`, `jail`, `reason`, `purge` (default on), `days` (1-14, default 14) |
